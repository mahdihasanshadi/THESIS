...
practice (5.11), and the decision each research question comes to on this evidence (5.12). Every
difference is a paired bootstrap interval; single-seed rows are marked and treated as indicative.

...
teachers' own scores, and without seeds or intervals \cite{prasomphan2025mtkd}; the Pre-Thesis II
report this work grew out of reported its teachers' scores but omitted the control, the seeds and
the intervals. Section~\ref{sec:5.5} tests both assumptions and finds both false on a committee

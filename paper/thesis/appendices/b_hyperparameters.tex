...
tests it as proposed; Section~\ref{sec:5.3} sweeps each of them around those defaults. Every other
setting, for the teachers and for the students, is in the table below, which is the single source
for all of them.
